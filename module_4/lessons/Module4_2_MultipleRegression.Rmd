...
```{r}
library(tidyverse)
site_data <- read_csv("site_changes.csv") %>% 
  mutate(year = as.factor(year)) # don't worry about this code too much--we want the year column treated as a category, not a number
```
